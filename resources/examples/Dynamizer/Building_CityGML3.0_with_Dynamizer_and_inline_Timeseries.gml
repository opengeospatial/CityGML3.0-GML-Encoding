        ...
        <con:RoofSurface gml:id="DEBY_LOD2_5744682_roofsurface1">
          ...
          <dynamizer>
            <dyn:Dynamizer gml:id="roofsurface1_Dynamizer">
              <dyn:attributeRef>//con:RoofSurface[@gml:id='DEBY_LOD2_5744682_roofsurface1']/genericAttribute/gen:DoubleAttribute[name='diffuse_irradiation']/gen:value</dyn:attributeRef>

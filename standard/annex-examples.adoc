...
Various CityGML 3.0 test data sets are available in the https://github.com/opengeospatial/CityGML3.0-GML-Encoding/tree/main/resources/examples[folder _examples_ on the CityGML 3.0 GML Encoding GitHub] for each CityGML module, including those test data sets presented in this chapter.

...
These basic types are no longer modelled as subclasses of the basic types _DoubleList_ and _DoubleBetween0and1List_, respectively. Instead, they provide now a single _list_ attribute themselves with a maximum multiplicity greater than 1 allowing to encode them as list-based XML Schema simple types.

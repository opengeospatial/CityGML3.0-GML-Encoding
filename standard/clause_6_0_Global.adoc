...
The GML file is available on the https://github.com/opengeospatial/CityGML3.0-GML-Encoding/tree/main/resources/examples/XLink-examples/1_SimpleBuilding[CityGML 3.0 Encodings Github].
...
The GML file is available on the https://github.com/opengeospatial/CityGML3.0-GML-Encoding/tree/main/resources/examples/XLink-examples/2_SimpleBuilding_Roof_Overhangs[CityGML 3.0 Encodings Github].
...
The GML file is available on the https://github.com/opengeospatial/CityGML3.0-GML-Encoding/tree/main/resources/examples/XLink-examples/3_Building_With_Nested_Features[CityGML 3.0 Encodings Github].
...
The GML file is available on the https://github.com/opengeospatial/CityGML3.0-GML-Encoding/tree/main/resources/examples/XLink-examples/4_Cross-Top-Level-XLink[CityGML 3.0 Encodings Github].
